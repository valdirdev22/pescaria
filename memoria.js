...
const imagens = ['./img/edwiges.jpg', './img/espirito_santo.jpg', 
'./img/maria.jpg', './img/odilia.jpg', './img/familia.jpg', 
'./img/pedro_2.jpg'];
...
onload = () => {
    ...
    document.body.style.backgroundImage = "url('./img/backgraound_3.jpg')";
};
...
const inicioJogo = () => {
  ...
  // Reinicia o estado do jogos
    ...
    document.body.style.backgroundImage = "url('./img/backgraound_2.jpg')";
...
temCartaVirada = false;
 ...
 if(pontos == 6) {
    ...
    document.body.style.backgroundImage = "url('./img/maria.jpg')";
    timerDoJogo.stop(); 
}     
